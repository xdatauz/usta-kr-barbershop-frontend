...
const AboutPage = ({ preview = false }: AboutPageProps) => {
	...
	const team = [
		{ key: "jamshid", image: "/images/barbers/1.webp" },
		{ key: "sardor", image: "/images/barbers/2.webp" },
		{ key: "aziz", image: "/images/barbers/3.webp" },
	] as const;
				...
				<div className="space-y-4">
					...
					<div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
						{visibleTeam.map((member, index) => (
							...
							>
								<img src={member.image} alt={t(`aboutSection.team.${member.key}.name`)} className="h-44 w-full object-cover" />
